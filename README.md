...
2. Use YARA rules to hunt for newer variants of the same malware strain/family in file repositories, backups, and shared drives especially with recursive directory scanning (also all files in its subdirectories)
...
truncated privateloader.yar YARA rule: 
```
...
https://www.youtube.com/watch?v=fu71CljrxsU&t=1397s  ) README -->
